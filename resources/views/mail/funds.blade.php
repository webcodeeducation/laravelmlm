                ...
                <tr>
                    <td align="center" valign="top" style="padding-bottom:30px;">
                        <table border="0" cellpadding="20" cellspacing="0" width="90%" id="emailBody" valign="top">
                            <tr>
                                <td align="center">
                                    <h2 style="margin-top: 0">Add Funds Request!</h2>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                      <p>Dear {{ $data['name'] }}, </p>
                                    <p>This email is to advise you that your recently submitted add funds request has now been processed and is on its way to your nominated account.</p>
                                     <p>Your Requested Details:  </p><br>
                                        ...
                                        <table width="570" border="0" cellspacing="0" cellpadding="0">
										  ...
										  <tr>
                                            <td width="155" height="34"><span class="style8"> Currency</span></td>
                                            <td width="18" align="center">:</td>
                                            <td width="397"><span class="style21">USD</span></td>
                                          </tr>
                                          <tr>
                                            <td width="155" height="33"><span class="style8">Funding Amount</span></td>
                                            <td width="18" align="center">:</td>
                                            <td width="397"><span class="style21">{{ number_format($data['amount'],2) }}</span></td>
                                          </tr>
                                          <tr>
                                            <td width="155" height="33"><span class="style8">Type</span></td>
                                            <td width="18" align="center">:</td>
                                            <td width="397"><span class="style21">{{ $data['type'] }}</span></td>
                                          </tr>
                            ...
                            <tr>
                                <td>
                                     <p>To check the status of your add funds request, please visit the "History" page or lower section of the Dashboard Area and the "History" page to see details of previous add funds request.</p>
